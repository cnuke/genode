...
namespace Gpu {
	 ...
	 * Type of mapping
	 */
	enum class Mapping_type { INVALID, READ, WRITE, NOSYNC };
...
struct Gpu::Session : public Genode::Session
{
	...
	/**
	 * Obtain dataspace for given buffer id
	 *
	 * \param id  buffer id
	 *
	 * \throw Invalid_id
	 */
	// virtual Genode::Dataspace_capability buffer_dataspace(Buffer_id id) = 0;
