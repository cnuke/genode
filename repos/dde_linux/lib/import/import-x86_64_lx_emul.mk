...
INC_DIR += $(REP_DIR)/src/lib/lx_kit/spec/x86
...
LIBS += x86_64_linux_generated

LX_SRC_DIR := $(call select_from_ports,x86_linux)/src/linux
ifeq ($(wildcard $(LX_SRC_DIR)),)
LX_SRC_DIR := $(call select_from_repositories,src/linux)
endif

LX_GEN_DIR := $(LIB_CACHE_DIR)/x86_64_linux_generated
